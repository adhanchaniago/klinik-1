...
<script type="text/javascript" >
	...
	var tgllhr= new Array();
	var pekerjaan=new Array();
	var alamat=new Array();
	var telpon=new Array();
	var jeniskel=new Array();
	var namakk=new Array();
	var tgldaftar=new Array();
	...
	function simpan(){
			...
			var jeniskel=$("#jeniskel").val();
			var namakk=$("#namakk").val();
			var tgldaftar=$("#tgldaftar").val();
			$("#loading").show();
			$.ajax({
				url:"aksi2.php",
				data:"&noreg="+noreg+"&namapasien="+namapasien+"&tgllhr="+tgllhr+"&pekerjaan="+pekerjaan+"&alamat="+alamat+"&telpon="+telpon+"&jeniskel="+jeniskel+"&namakk"+namakk+"&tgldaftar"+tgldaftar,
				cache: false;
